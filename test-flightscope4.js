...
// Golf ball physics test script - FlightScope4 Dataset (v4.4.4)
// Tests THREE-REGIME PHYSICS against flightscope4.csv (18 shots)
// Run with: node test-flightscope4.js
...
// FlightScope4.csv contains only iron shots (61-92 mph range)

// Test against flightscope4.csv (18 new iron shots)
console.log('=== FLIGHTSCOPE4.CSV TEST (18 shots) - v4.4.4 THREE-REGIME PHYSICS ===\n');

const fsData = fs.readFileSync('/home/shreen/Documents/flightscope4.csv', 'utf-8');
...
console.log(`\nFlightScope4: ${ironPassCount}/${ironTestCount} passing (${((ironPassCount/ironTestCount)*100).toFixed(0)}%), Avg error: ${(ironTotalError / ironTestCount).toFixed(1)} yds\n`);
